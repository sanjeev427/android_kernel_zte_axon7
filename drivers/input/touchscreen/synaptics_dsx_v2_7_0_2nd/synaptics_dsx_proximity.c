...
static struct device_attribute attrs[] = {
	__ATTR(hover_finger_en_2nd, (S_IRUGO | S_IWUGO),
...
int synaptics_rmi4_prox_hover_finger_en_2nd(bool enable)
{
	int retval;
...
EXPORT_SYMBOL(synaptics_rmi4_prox_hover_finger_en_2nd);
...
{
	synaptics_rmi4_new_function_2nd(&proximity_module, true);
...
{
	synaptics_rmi4_new_function_2nd(&proximity_module, false);
