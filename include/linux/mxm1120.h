...
#define M1120_IRQ_HALLSWITCH_NAME			"m1120-irq-hallswitch"
...
#define M1120_IOCTL_GET_CURRENT_STATUS		_IOR(M1120_IOCTL_BASE, 0x11, struct m1120_raw_data*)
#define M1120_IOCTL_GET_HALLSWITCH_STATUS		_IOR(M1120_IOCTL_BASE, 0x12, int*)
/* ********************************************************* */
...
typedef struct {
	...
	int					irq_hallswitch;
	int					hallswitchstate;
	struct delayed_work	work_hallswitch;
